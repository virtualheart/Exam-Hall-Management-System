        ...
        <div class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php if(isset($useroles)){  if(in_array("manage_Sub_asign",$useroles)){ ?> 
                            <ul aria-expanded="false" class="collapse">
                            <?php if(isset($useroles)){  if(in_array("add_subject",$useroles)){ ?> 
                                <li><a href="add_sub_asign.php">Asign Subject</a></li>
                            <?php } } ?>
                                <li><a href="view_sub_asign.php">View Asiginded</a></li>
                                <li><a href="view_cls_sub.php">View Classwise</a></li>
                    ...
                    <?php if(isset($useroles)){  if(in_array("manage_exam",$useroles)){ ?> 
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">Exam Management</span></a>
                            <ul aria-expanded="false" class="collapse"> 
                                <li><a href="add_roomtype.php">Add Building</a></li>
                                <li><a href="view_roomtype.php">View Building</a></li>
