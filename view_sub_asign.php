...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="del_sub_asign.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Yes</a>
      <a href="view_sub_asign.php" class="button button--error" data-for="js_success-popup">No</a>
    </p>
  </div>
</div>
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Asigned Subject</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Asigned Subjects</li>
                    </ol>
                </div>
            </div>
                 ...
                 <div class="card">
                          ...
                          <?php } } ?>
                                <div class="table-responsive m-t-40">
                                  ...
                                  $sql1 = "SELECT *,sa.id as sid  FROM tbl_subasign sa join tbl_class cl on sa.cls_id=cl.id join tbl_subject sub on sub.id=sa.p_id";
