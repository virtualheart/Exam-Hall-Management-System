...
require_once("PaytmKit/lib/encdec_paytm.php");
    ...
    $paytmParams["MID"] 		= "WpnyKI33859749414217";
    $paytmParams["CHANNEL_ID"] 	= 'WEB';
    $paytmParams["WEBSITE"] 	= "WEBSTAGING";
    $paytmParams["INDUSTRY_TYPE_ID"] = "Retail";
    $paytmParams["CALLBACK_URL"] = "http://127.0.0.1/Exam-Hall-Management-System/include/Paytm_PHP_Sample/response.php";
    $paytmChecksum = getChecksumFromArray($paytmParams, "O0zUdI1&G%OQViK_");
