                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   ...
                                   <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Exam Reg No</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="stud_id" class="form-control" placeholder="Exam Reg No" id="event" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  name="slname" id="lname" class="form-control" id="event" placeholder="Last Name" required="">
                                                </div>
                                            </div>
                                        </div>
